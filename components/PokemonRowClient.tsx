...
export const PokemonRowClient = memo(function PokemonRowClient({
  rank, name, usagePercent, rawCount, rankChange, view,
  ...
  return (
    <tr className="border-b border-white/5 hover:bg-white/5 transition-colors">
      ...
      <td className="py-3 px-4">
        <Link href={`/pokemon/${normalized}`} className="flex items-center gap-3 focus:outline-none focus:ring-2 focus:ring-indigo-500 rounded min-h-[44px]">

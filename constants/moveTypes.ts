...
export const MOVE_TYPES: Record<string, string> = {
  ...
  'Aqua Step': 'water', 'Razor Shell': 'water', 'Triple Dive': 'water', 'Ice Spinner': 'ice',
  ...
  'Rising Voltage': 'electric', 'Thunderclap': 'electric', 'Electro Shot': 'electric',
  'Supercell Slam': 'electric', 'Electro Drift': 'electric', 'Aura Sphere': 'fighting',
  ...
  'Collision Course': 'fighting', 'Axe Kick': 'fighting',
  'Kowtow Cleave': 'dark',
  ...
  'Shore Up': 'ground', 'Spikes': 'ground', 'Headlong Rush': 'ground', 'Sandsear Storm': 'ground',
  ...
  'Tailwind': 'flying', 'Defog': 'flying', 'Aerial Ace': 'flying', 'Bleakwind Storm': 'flying',
  ...
  'Rock Blast': 'rock', 'Smack Down': 'rock', 'Power Gem': 'rock', 'Salt Cure': 'rock',
  'Stone Axe': 'rock', 'Mighty Cleave': 'rock',
  ...
  'Fickle Beam': 'dragon', 'Order Up': 'dragon',
  ...
  'Make It Rain': 'steel', 'Hard Press': 'steel', 'Spin Out': 'steel', 'Shelter': 'steel',
  ...
  'Baby-Doll Eyes': 'fairy', 'Fleur Cannon': 'fairy', 'Springtide Storm': 'fairy',
  'Alluring Voice': 'fairy', 'Luminance': 'fairy',
}
